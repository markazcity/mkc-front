        ...
        <div  style={{ backgroundColor: "#F8FAF8" }}  className="pb-20">
                ...
                <div className="grid lg:grid-cols-2 lg:mx-64">
            {
                educationList.map(edu=>(
                    ...
                    >
                        <div
                        className="relative py-8 px-4 lg:p-10 mx-10 lg:mx-0 lg:my-0 h-full"
                        style={
