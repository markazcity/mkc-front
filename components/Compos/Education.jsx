...
const Education = (props) => {
  ...
  const educationList = [
    ...
    },
    {
      wc_title: "AIMER",
      wc_body:
        "Avaan Institute of Management Education and Research is a business school with an impact located in Markaz Knowledge City. It’s a locus where great minds, visionaries, and young talents come together to develop businesses and come up with region-specific solutions to management problems.  ",
      wc_image: "aimer.jpg",
    ...
    },
    {
      ...
      wc_body:
        "As part of its journey towards bringing innovation and development in the educational sector, Markaz Knowledge City formed Malaibar Foundation for Research and Development as a platform for clubbing experts in the proposed area for more creative dialogues and discussions. Malaibar Foundation intends to fulfill the aim of advanced research followed by the production of new knowledge in the fields of arts, science, managements, technology, and literature.",
    ...
    },
    {
      wc_title: "MeeM",
      wc_body:
        "MeeM is the virtual platform of Markaz Knowledge City developed as part of its mission for global education. Through this, thousands of active learners from across the world are able to pursue primary to advanced level education in various disciplines. It is supported with highly qualified technical professionals and subject experts from all fields of study. MeeM is also moving ahead to achieve its unique goal of erasing the boundaries of nations for the universal dissemination of knowledge and shared human values.",
      wc_image: "meem.jpg",
...

    {
      ...
      wc_body:
        "As part of creating good medical professionals in the field of Nursing activities, we create a brand of trust and truth. Our nursing college would be at the forefront of delivering qualified experts for various medical fields. The project includes academics and field professionals in the various health sectors.",
    ...
    },
    {
      ...
      wc_body:
        "For nurturing the best professionals in the field of pharmaceuticals, we begin a centre for the study. We aim to build a better generation who has the professional capacity as well research capacity. The team of the project includes experts in different fields of knowledge and experience.",
  ...
  return (
    <div className="education-section pb-8 py-5">
      <h1
        className="text-4xl lg:text-5xl font-extrabold mb-5 text-center pt-10"
        style={{
          color: "#69696D",
        }}
        data-aos="zoom-in"
      ...
      <section className="grid md:grid-cols-2 xl:grid-cols-3 mx-10 lg:mx-32 3xl:mx-64">
        {props.dataset.map((edu, index) => (
          <div
            className="w-full h-auto my-4 pb-2 mx-3  bg-white component-container"
            key={index}
            data-aos="fade-up"
            ...
            onMouseOver={() => {
              if (edu.wc_video != null && edu.wc_video.length > 8) {
                document
                  ...
                  .classList.add("animate-back");
                document
                  .getElementById(`index${index}`)
                  .classList.add("animate-down");
              }
            }}
            onMouseOut={() => {
              document
                .getElementById(`icon${index}`)
                .classList.remove("animate-back");
              document
                .getElementById(`index${index}`)
                .classList.remove("animate-down");
              document
                .getElementById(`index${index}`)
                .classList.add("anim-fade");
            }}
          >
            <div className="relative">
              ...
              >
                <div
                  className=" relative bg-violet-600  rounded-full
                  ...
                  onClick={() => {
                    if (edu.wc_video != null && edu.wc_video.length > 5) {
                      setVideoLink(
                        ROOT_URL + "webContents/uploads/" + edu.wc_video
                      );
                    }
                  }}
                >
                  ...
                  <AiOutlinePlayCircle
                    className="absolute text-white text-2xl mb-28"
                    id={`icon${index}`}
                  />

                  <h1
                    className="absolute font-bold text-white text-2xl "
                    id={`index${index}`}
                  >
                    {index + 1}
                  </h1>
      ...
      {videoLink != null && videoLink.length > 5 ? (
        <VideoModal link={videoLink} onClose={() => setVideoLink(null)} />
      ) : (
        <></>
      )}
    </div>
