...
const FirstSection = () => {
  ...
  return (
    ...
    >
      <main className="absolute -z-1 bg-black w-full h-full">
        <section
          className="absolute"
          style={{
            width: "100%",
        ...
        >
          ...
          >
            <source
              src="https://api.markazcity.in/siteAssets/home2.mp4"
        ...
        <div>
          <div
            className={
              "text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold text-white lg:ml-32 ml-10 " +
              styles.slideTexts
            }
          >
            ...
            <div
              className={styles.homeTextFade}
              style={{ marginRight: "50vw", wordWrap: "break-word" }}
            >
