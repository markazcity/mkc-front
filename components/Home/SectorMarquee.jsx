...
const SectorMarquee = () => {
  ...
  const sectors = [
    {
      title: "Education",
      icon: <BiBookAlt style={{ height: "30px", width: "30px" }} />,
      link: null,
    },
    {
      title: "Health",
      icon: <RiMentalHealthLine style={{ height: "30px", width: "30px" }} />,
      link: null,
    },
    {
      title: "Tourism",
      icon: <GiPalmTree style={{ height: "30px", width: "30px" }} />,
      link: null,
    },
    {
      title: "Entertainment",
      icon: <BiNetworkChart style={{ height: "30px", width: "30px" }} />,
      link: null,
    },
    {
      title: "Entrepreneurship",
      icon: <RiBuilding2Line style={{ height: "30px", width: "30px" }} />,
      link: null,
    },
    {
      title: "Design",
      icon: <BiPaint style={{ height: "30px", width: "30px" }} />,
      link: null,
    },
    {
      title: "Technology",
      icon: <FiCodesandbox style={{ height: "30px", width: "30px" }} />,
      link: null,
    },
    {
      title: "Manufacturing",
      icon: <IoConstructOutline style={{ height: "30px", width: "30px" }} />,
      link: null,
    },
    {
      title: "Heritage",
      icon: <BiPyramid style={{ height: "30px", width: "30px" }} />,
      link: null,
    },
    {
      title: "Food",
      icon: <IoFastFoodOutline style={{ height: "30px", width: "30px" }} />,
      link: null,
    },
    {
      title: "Energy",
      icon: <GiElectric style={{ height: "30px", width: "30px" }} />,
      link: null,
    },
    {
      title: "Water",
      icon: <IoWaterOutline style={{ height: "30px", width: "30px" }} />,
      link: null,
    },
    {
      title: "Sports",
      icon: <BiFootball style={{ height: "30px", width: "30px" }} />,
      link: null,
    },
  ];
