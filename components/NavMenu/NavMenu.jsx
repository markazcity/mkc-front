...
export const NavMenu = ({ items }) => {
  ...
  return (
    <div
      className="absolute z-50 bg-violet-700 right-0 top-0 bottom-0 left-0 "
      data-aos="fade-down"
      id="mobile-menu"
    ...
    >
      ...
      <div className="absolute left-0 bottom-0 text-white p-10">
        <SocialIcons />
        <div className="mt-2">&copy; markazknowledgecity</div>
      </div>
...
export const DesktopMenu = ({ items, textColor }) => {
  ...
  return (
    <nav
      className={
        "absolute z-30 right-0  top-2 my-5 xl:mr-24 xl:mt-16 rounded " + color
      }
    >
