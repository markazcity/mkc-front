      ...
      (_ret =
        ((_temp =
          ((_this = possibleConstructorReturn(
            this,
            (_ref =
              ReactBackgroundSlideshow.__proto__ ||
              Object.getPrototypeOf(ReactBackgroundSlideshow)).call.apply(
              _ref,
              [this].concat(args)
            )
          )),
        ...
        (_this.state = {
          ...
          direction: "next",
          current:
            typeof _this.props.startAt !== "undefined"
              ? _this.props.startAt
              : (Math.random() * _this.props.images.length) | 0,
          ...
          _this.setState(
            ...
            function () {
              var _this$props = _this.props,
                ...
                images =
                  _this$props$images === undefined ? [] : _this$props$images;
              var current = _this.state.current;
              ...
              tiles.map(function (_, j) {
                var transform =
                  isCurrent && isAnimating
                    ? _this2._transforms[effectName][direction][j]
                    : null;

                var style = transform
                  ? { transform: transform, WebkitTransform: transform }
                  : null;
