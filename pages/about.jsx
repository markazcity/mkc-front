...
const About = ({ data }) => {
  ...
  useEffect(() => {
    if (data != null) {
      ...
      setPhilosophy(
        data.data.filter((item) => item.wc_category === "about_philosophy")
      );
      setJourney(
        data.data.filter((item) => item.wc_category === "about_journey")
      );
      setPast(data.data.filter((item) => item.wc_category === "about_past"));
      setLeadership(
        data.data.filter((item) => item.wc_category === "about_leadership")
      );
    }
  }, [data]);
