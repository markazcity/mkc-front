                ...
                <div>
                    {
                        jobPos.map((pos)=>{
                            ...
                            (<div key={pos.jp_id}>
                                ...
                                className="bg-gray-100 rounded my-4 px-6 py-4 shadow-lg flex justify-between items-center"
                                >
<input type="text"
id={pos.jp_id}
...
>
    <RiDeleteBin6Line className="text-red-600 text-xl "/></div>   
...
export const NewPosition = (props)=>{
    ...
    >
        <div className="py-6 px-4">
            <span className="font-bold text-2xl text-blue-800 inline-block mb-3">Add Position</span> <br />
...
<br />
            ...
            <button className="bg-blue-600 hover:bg-blue-700  text-white px-4 py-3 rounded mr-2 mt-2"
            onClick={() =>{
                setAdding(true);
                newItem(name)
            }}
