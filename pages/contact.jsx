...
const Contact = () => {
  ...
  return (
    <div>
      ...
      <section className="absolute z-10 top-0 px-10 py-28 md:py-52 flex justify-center w-full">
          ...
          <div className="md:grid md:grid-cols-12 bg-white shadow">
            ...
            >
              ...
              <p className=" px-10 text-white">
                <span className="text-xl font-bold">MARKAZ KNOWLEDGE CITY</span>{" "}
                <br />
                  ...
                  <div className="px-4 py-5  sm:p-6">
                    <div className="">
                      ...
                      <div
                        className={
                          error == null
                            ? "my-1 px-4 py-2  bg-opacity-20  rounded inline-block  bg-white text-white"
